...
app.get('/team_stats', function(req, res){
  ...
  var q3 = 'SELECT count(*) FROM football_games WHERE visitor_score > home_score';
...
app.get('/player_info', function(req,res){
  var q = 'SELECT id, name FROM football_players;';
  db.any(q)
    .then(function(rows) {
...
app.get('/player_info/select_player', function(req,res){
  ...
  var selectPlayer = "SELECT * FROM football_players WHERE id='" + player_id + "';";
